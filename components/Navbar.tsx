...
// export function expandedMenuReducer(){
//     switch
// }
        ...
        <>
            <div className="fixed flex top-0 w-full h-[80px] z-[999] justify-center items-center">
                <div className='flex w-full max-w-[1440px] justify-between items-center px-4 md:px-10'>
                    <div className="flex justify-center items-center gap-14">
                        ...
                        <div className="hidden md:flex items-center gap-10">
                            <Popover className="relative">
                                {({open}) => (
                                    <>
                                        <Popover.Button className="flex items-center gap-1 text-[#686868] hover:text-black ease-linear duration-200 cursor-pointer outline-none"
                                            onMouseEnter={()=>{
                                                setIsHoverMenu(0);
                                            }}
                                            onMouseLeave={()=>{
                                        ...
                                        >
                                            <Popover.Panel className="flex flex-col items-center py-5 px-6 absolute top-3 right-0 bg-white rounded-lg shadow-xl text-[#686868] text-[14px] gap-2">
                                                <div className="flex items-center gap-4 w-[110px] justify-start">
                                ...
                                {({open}) => (
                                    <>
                                        ...
                                        >
                                            ...
                                            {open ?
                                            <svg width={10} height={6} xmlns="http://www.w3.org/2000/svg">
                                                <path stroke={`${isHoverMenu === 1 ?'#020202' : ' #686868'}`} className="ease-linear duration-200" strokeWidth={1.5} fill="none" d="m1 5 4-4 4 4" />
                                            </svg>
                                            :
                                            <svg width={10} height={6} xmlns="http://www.w3.org/2000/svg">
                                                <path stroke={`${isHoverMenu === 1 ?'#020202' : ' #686868'}`} className="ease-linear duration-200" strokeWidth={1.5} fill="none" d="m1 1 4 4 4-4" />
                                            </svg>
                                            }
                                        </Popover.Button>
                                        <Transition
                                            ...
                                            leaveTo="transform scale-95 opacity-0"
                                        >
                                            <Popover.Panel className="flex flex-col items-center py-5 px-6 absolute top-3 left-0 bg-white rounded-lg shadow-xl text-[#686868] text-[14px] gap-2">
                                                <div className="flex items-center gap-4 w-[70px] justify-start">
                                                    <p>History</p>
                                                </div>
                                                <div className="flex items-center gap-4 w-[70px] justify-start">
                                                    <p>Our Team</p>
                            ...
                            <div className="flex items-center gap-1 text-[#686868] hover:text-black ease-linear duration-200 cursor-pointer"
                                onMouseEnter={()=>{
                                    setIsHoverMenu(2);
                                }}
                                onMouseLeave={()=>{
                    ...
                    <div className="hidden md:flex justify-center items-center gap-10 text-[14px]">
                        <p className="text-[#686868] hover:text-black ease-linear duration-200 cursor-pointer">Login</p>
                        <div className="flex px-5 py-2 rounded-xl border-[2px] border-[#9a9a9a] hover:border-black text-[#686868] hover:text-black ease-linear duration-200 cursor-pointer">
                            Register
                        </div>
                    </div>
